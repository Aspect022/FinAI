  ...
  return (
    <main className="p-4 md:p-6 space-y-6">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-pretty">{t("recommendations")}</h2>
        <div className="grid grid-cols-1 gap-4">
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base">SIP in Balanced Fund</CardTitle>
                <span className="text-xs px-2 py-0.5 rounded-md border">Medium</span>
              </div>
              <div className="text-sm text-muted-foreground">Expected: 12-14% p.a.</div>
            </CardHeader>
            <CardContent className="pt-0">
              ...
              <Button size="sm" asChild>
                <a href="/recommendation" aria-label="View details for SIP in Balanced Fund">
                  View Details
                </a>
              </Button>
            </CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs px-2 py-0.5 rounded-md border">Low</span>
              </div>
              <div className="text-sm text-muted-foreground">Expected: 6.5-7% p.a.</div>
            </CardHeader>
            <CardContent className="pt-0">
              <p className="text-sm text-pretty text-foreground/80 mb-3">Safe, steady returns for short-term goals.</p>
              <Button size="sm" asChild>
                <a href="/recommendation" aria-label="View details for Recurring Deposit">
                  View Details
                </a>
              </Button>
            </CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-base">Blue-Chip Equity SIP</CardTitle>
                <span className="text-xs px-2 py-0.5 rounded-md border">High</span>
              </div>
              <div className="text-sm text-muted-foreground">Expected: 14-16% p.a.</div>
            </CardHeader>
            <CardContent className="pt-0">
              <p className="text-sm text-pretty text-foreground/80 mb-3">
              ...
              <Button size="sm" asChild>
                <a href="/recommendation" aria-label="View details for Blue-Chip Equity SIP">
                  View Details
                </a>
              </Button>
            </CardContent>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-pretty">Financial Literacy</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <EducationCard
            ...
            progress={45}
          />
          <EducationCard title="Emergency Funds 101" mode="3 min video" difficulty="Beginner" state="not-started" />
        </div>
      </section>

      <section className="space-y-3 mb-20">
        <h2 className="text-lg font-semibold text-pretty">Monthly Savings Trend</h2>
        <Card className="shadow-sm">
